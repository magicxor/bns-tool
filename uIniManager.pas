...
type
  ...
  public
    ...
    property HotKeysMultilinePaste: Integer read FHotKeysMultilinePaste
      write FHotKeysMultilinePaste;
  end;
...
begin
  ...
  begin
    ...
    FHotKeysMultilinePaste := Ini.ReadInteger(csIniHotKeysSection, csIniHotKeysMultilinePaste,
      220 { \ } );
  end;
end;
